...
ENV REDIS_URI='redis://default:A4mwGguPlhLGeCCfWC8D@containers-us-west-158.railway.app:6984'
...
ENV WEBHOOK_EVENTS_MESSAGES_UPDATE=false
ENV WEBHOOK_EVENTS_MESSAGES_UPSERT=true
ENV WEBHOOK_EVENTS_SEND_MESSAGE=true
ENV WEBHOOK_EVENTS_CONTACTS_SET=true
ENV WEBHOOK_EVENTS_CONTACTS_UPSERT=false
ENV WEBHOOK_EVENTS_CONTACTS_UPDATE=false
ENV WEBHOOK_EVENTS_PRESENCE_UPDATE=false
ENV WEBHOOK_EVENTS_CHATS_SET=false
ENV WEBHOOK_EVENTS_CHATS_UPSERT=true
ENV WEBHOOK_EVENTS_CHATS_UPDATE=false
ENV WEBHOOK_EVENTS_CONNECTION_UPDATE=false
